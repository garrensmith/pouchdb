...
function ajax(options, callback) {
  ...
  var parseCookie = function (cookies) {
    ...
    var cookieString = jar.getCookieString(options.url);
    console.log('cs', document.cookie, cookieString);
    var cookies = parseCookie(cookieString);
    console.log('parsed', cookies);
    options.headers['X-CouchDB-CSRF'] =  cookies['CouchDB-CSRF'] || true;
    options.headers['X-CouchDB-CSRF'] =  true;
  /*} else {
    options.headers['X-CouchDB-CSRF'] =  true;
    console.log('set true', options.headers);
  }*/

  console.log('hheader', options.headers);
